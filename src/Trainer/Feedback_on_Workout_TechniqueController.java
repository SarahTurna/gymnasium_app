 ...
 * @author Ac
 */
public class Feedback_on_Workout_TechniqueController implements Initializable {
    ...
    @FXML
    private TextField memIDTextFrield;
    @FXML
    private TableView<?> WorkoutTechniqueTableView;
    @FXML
    ...
    @FXML
    private void ReviewWorkoutTechniqueButtonOnclick(ActionEvent event) {
    }
