...
public class MakeAppointmentController implements Initializable {
    ...
    @FXML
    private DatePicker dateOfAppointmentDatePicker;
    @FXML
    private ComboBox selectAppointmentTimeComboBox;
    @FXML
    private ComboBox<?> selectMemberForAppointmentComboBox;
    @FXML
    ...
    @FXML
    private void makeAnAppointButtonOnClick(ActionEvent event) {
    }
