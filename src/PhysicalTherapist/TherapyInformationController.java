 ...
 * @author lobo
 */
public class TherapyInformationController implements Initializable {

    @FXML
    private TextArea AddNewInfoTextArea;
    @FXML
    ...
    @FXML
    private void addNewInfoToListOnClick(ActionEvent event) {
    }
