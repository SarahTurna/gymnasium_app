...
public class CreateScheduleController implements Initializable {
    ...
    @FXML
    private ComboBox scheduleToComboBox;
    @FXML
    private TextField nameAndIdTextField;
    @FXML
    private DatePicker dateForScheduleDatePicker;
    @FXML
    private ComboBox timeForScheduleDatePicker;
    @FXML
    ...
    @FXML
    private void submitScheduleButtonOnClick(ActionEvent event) {
    }
